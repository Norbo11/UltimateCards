...
public class Card
{
    ...
    {
        if (suit.equals("Spades")) return ChatColor.GRAY + rank + " of " + suit + p.white;
        if (suit.equals("Clubs")) return p.gray + rank + " of " + suit + p.white;
        if (suit.equals("Diamonds")) return ChatColor.RED + rank + " of " + suit + p.white;
        if (suit.equals("Hearts")) return p.darkRed + rank + " of " + suit + p.white;
        return "";
    }
}
